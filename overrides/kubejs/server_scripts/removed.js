...
ServerEvents.recipes(e => {
    ...
    // e.remove({id: '/^create:crushing/raw_.*_ore$/'})
    // e.remove({id: '/^create:crushing/(?!raw_).*_ore$/'})
    e.remove({id: '/^create:crushing/.*_ore$/'})
    e.remove({id: '/^create:crushing/raw_.*_block$/'})
    e.remove({id: 'emendatusenigmatica:crushed/from_raw_crushing/rutile'})
    e.remove({id: 'emendatusenigmatica:crushed/from_raw_block_crushing/rutile'})
})
