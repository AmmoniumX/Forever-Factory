...
ServerEvents.recipes(e => {
    ...
    e.recipes.create.emptying([Fluid.of('kubejs:liquid_sunlight', 250), 'naturesaura:bottle_two_the_rebottling'], Item.of('naturesaura:aura_bottle', '{stored_type:"naturesaura:overworld"}'))
    e.recipes.create.emptying([Fluid.of('kubejs:liquid_ghosts', 250), 'naturesaura:bottle_two_the_rebottling'], Item.of('naturesaura:aura_bottle', '{stored_type:"naturesaura:nether"}'))
    e.recipes.create.emptying([Fluid.of('kubejs:liquid_darkness', 250), 'naturesaura:bottle_two_the_rebottling'], Item.of('naturesaura:aura_bottle', '{stored_type:"naturesaura:end"}'))
})
